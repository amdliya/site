...
const API_URL = 'https://script.google.com/macros/s/AKfycbzUp_bK_YkVFTv8pLq79u2mqLjpFK5Icy75LnIXgAE3OGcTD4LBxTqLkvrxcUvLR6o/exec';
    ...
    return new Promise((resolve) => {
        ...
        for (const key in params) {
            if (params.hasOwnProperty(key)) {
                // Pastikan semua nilai adalah string tanpa menggunakan JSON.stringify                url += `&${key}=${encodeURIComponent(String(params[key]))}`;
            }
        }
